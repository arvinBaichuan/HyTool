...
import com.baichuan.hy.tool.dao.THostMapper;
import com.baichuan.hy.tool.domain.THost;
import com.baichuan.hy.tool.ui.Init;
import com.baichuan.hy.tool.ui.UiConsts;
import com.baichuan.hy.tool.ui.component.textviewer.HostRTextScrollPane;
import com.baichuan.hy.tool.ui.component.textviewer.HostRSyntaxTextViewer;
import com.baichuan.hy.tool.ui.dialog.TranslationDialog;
import com.baichuan.hy.tool.ui.frame.ColorPickerFrame;
import com.baichuan.hy.tool.ui.listener.func.HostListener;
...
public class HostForm {
        ...
        try {
            ...
            if (SystemUtil.isWindowsOs()) {
                ...
                if (App.trayIcon != null) {
                    App.trayIcon.displayMessage("HyTool", "Host已切换！\n" + hostName, TrayIcon.MessageType.INFO);
    ...
    public static void initListTable() {
        ...
        if (!SystemUtil.isLinuxOs()) {
            ...
            JMenuItem openItem = new JMenuItem("HyTool");
