...
import com.baichuan.hy.tool.ui.component.QuickNoteListTableInCellRenderer;
import com.baichuan.hy.tool.ui.component.textviewer.QuickNoteRSyntaxTextViewer;
import com.baichuan.hy.tool.ui.component.textviewer.QuickNoteRSyntaxTextViewerManager;
import com.baichuan.hy.tool.ui.form.MainWindow;
import com.baichuan.hy.tool.ui.listener.func.QuickNoteListener;
import com.baichuan.hy.tool.util.JTableUtil;
...
public class QuickNoteForm {
    ...
    public final static String[] COLOR_KEYS = {
            "default", "Hy.note.color.color1", "Hy.note.color.color2", "Hy.note.color.color3",
            "Hy.note.color.color4", "Hy.note.color.color5", "Hy.note.color.color6",
            "Hy.note.color.color7", "Hy.note.color.color8", "Hy.note.color.color9",
            "Hy.note.color.color10", "Hy.note.color.color11", "Hy.note.color.color12",
            "Hy.note.color.color13", "Hy.note.color.color14", "Hy.note.color.color15",
            "Hy.note.color.color16", "Hy.note.color.color17"
    };
    ...
    private QuickNoteForm() {
        colorButton = new JToggleButton(new AccentColorIcon("Hy.accent.blue"));
