package com.baichuan.hy.tool.ui;
...
public class UiConsts {
     ...
     * 软件名称,版本
     */
    public static final String APP_NAME = "HyTool";
     ...
     * 软件版本检查url
     */
    public static final String CHECK_VERSION_URL = "https://github.com/arvinBaichuan/java-form-project/tree/main/src/main/resources/version_summary.json";

    /**
     * 软件下载链接信息url
     */
    public static final String DOWNLOAD_LINK_INFO_URL = "https://github.com/arvinBaichuan/java-form-project/blob/main/download_links.json";

    /**
     * Grace信息url
     */
    public static final String GRACE_INFO_URL = "https://github.com/arvinBaichuan/java-form-project/blob/main/grace.json";
