...
public class UiConsts {
     ...
     * 软件版本检查url
     */
    public static final String CHECK_VERSION_URL = "https://github.com/arvinBaichuan/HyTool/tree/master/src/main/resources/version_summary.json";

    /**
     * 软件下载链接信息url
     */
    public static final String DOWNLOAD_LINK_INFO_URL = "https://github.com/arvinBaichuan/HyTool/blob/master/download_links.json";

    /**
     * Grace信息url
     */
    public static final String GRACE_INFO_URL = "https://github.com/arvinBaichuan/HyTool/blob/master/grace.json";
