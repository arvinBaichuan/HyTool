...
import com.baichuan.hy.tool.ui.form.func.*;
import com.baichuan.hy.tool.util.*;
...
public class SettingDialog extends JDialog {
    ...
    public static String[] accentColorKeys = {
            ...
            "Hy.accent.blue",
            "Hy.accent.purple",
            "Hy.accent.red", "Hy.accent.hyRed",
            "Hy.accent.orange",
            "Hy.accent.yellow", "Hy.accent.hyYellow", "Hy.accent.hyYellow2",
            "Hy.accent.hyGreen", "Hy.accent.green", "Hy.accent.weGreen"
    };
    private static String[] accentColorNames = {
            "Default", "Blue", "Purple", "Red", "Orange", "Yellow", "Green", "HyYellow"
    };
        ...
        dbFilePathSaveButton.addActionListener(e -> {
            try {
                ...
                if (StringUtils.isNotBlank(dbFilePath)) {
                    FileUtil.copy(dbFilePathBefore + File.separator + "HyTool.db", dbFilePath, false);
                }
                ...
                App.config.save();
                JOptionPane.showMessageDialog(contentPane, "保存成功！\n\n需要重启HyTool生效", "成功", JOptionPane.INFORMATION_MESSAGE);
                JOptionPane.showMessageDialog(contentPane, "HyTool即将关闭！\n\n关闭后需要手动再次打开", "HyTool即将关闭", JOptionPane.INFORMATION_MESSAGE);
                System.exit(0);
            } catch (Exception e1) {
