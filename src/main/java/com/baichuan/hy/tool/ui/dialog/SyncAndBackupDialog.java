...
import com.baichuan.hy.tool.ui.listener.func.ImageListener;
...
public class SyncAndBackupDialog extends JDialog {
    ...
    public SyncAndBackupDialog() {
        ...
        String localDataPath = SystemUtil.CONFIG_HOME + File.separator + "HyTool.db";
        ...
        exportDataButton.addActionListener(e -> {
            ...
            File exportFile = FileUtil.touch(exportPath + File.separator + "HyTool.db");
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("用于同步HyTool数据的Git仓库地址：");
